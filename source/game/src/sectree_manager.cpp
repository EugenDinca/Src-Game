#include "stdafx.h"
#include <sstream>
#include "../../libs/libgame/include/targa.h"
#include "../../libs/libgame/include/attribute.h"
#include "config.h"
#include "utils.h"
...
#ifdef ENABLE_BOSS_REGEN
			snprintf(szFilename, sizeof(szFilename), "%s/%s/new_boss.txt", c_pszMapBasePath, szMapName);
			CBossRegen::Instance().LoadRegen(szFilename, setting.iIndex, setting.iBaseX, setting.iBaseY);
#endif
...
#ifdef ENABLE_BOSS_REGEN
	CBossRegen::Instance().FirstRegen();
#endif
	fclose(fp);
