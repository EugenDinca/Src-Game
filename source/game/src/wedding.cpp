...
namespace marriage
{
	...
	void WeddingMap::SetEnded()
	{
		...
		Notice("The wedding will be over soon.");
		Notice("When the wedding is over, you will be sent to the village.");
#else
		Notice(LC_TEXT("The wedding will be over soon."));
		Notice(LC_TEXT("When the wedding is over, you will be sent to the village."));
#endif
