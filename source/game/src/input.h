...
protected:
	...
	int			Biolog(LPCHARACTER ch, const char* data, UINT uiBytes);
#endif
#ifdef ENABLE_IN_GAME_LOG_SYSTEM
	int			InGameLog(LPCHARACTER ch, const char* data, UINT uiBytes);
#endif
#ifdef ENABLE_ITEM_TRANSACTIONS
	int			ItemTransactions(LPCHARACTER ch, const char* data, int BufferLeft);
#endif
#ifdef ENABLE_PM_ALL_SEND_SYSTEM
	void		BulkWhisperManager(LPCHARACTER ch, const char* c_pData);
#endif
#ifdef ENABLE_DUNGEON_INFO
	int			DungeonInfo(LPCHARACTER ch, const char* data, int BufferLeft);
#endif
	...
	int			NewPet(LPCHARACTER ch, const char* data, int BufferLeft);
#endif
	...
	int			RequestPartyBonus(LPCHARACTER ch, const char* data, size_t uiBytes);
#endif
...
public:
	...
	void		SendTPRequest(const char* c_pData);
#endif
#ifdef ENABLE_MULTI_LANGUAGE_SYSTEM
	...
	void		Dungeon(const char* c_pData);
#endif
#ifdef ENABLE_DUNGEON_TURN_BACK
	void		DungeonTurnBack(const char* c_pData);
#endif
protected:
